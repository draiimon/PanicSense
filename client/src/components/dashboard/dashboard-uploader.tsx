...
export function DashboardUploader({ onSuccess, className }: DashboardUploaderProps) {
  ...
  return (
    <div className="relative">
      ...
      {/* Centered Progress Indicator for Dashboard */}
      <AnimatePresence>
        {isUploading && (
          <motion.div 
            ...
            exit={{ opacity: 0, y: 20 }}
            className="absolute left-1/2 -translate-x-1/2 top-full mt-4 z-[90] w-full max-w-md"
          >
            <div className="bg-white/95 backdrop-blur-lg rounded-xl shadow-xl border border-blue-100 p-4">
