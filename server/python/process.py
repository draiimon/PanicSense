...
Location Guidelines:
- Return ONLY major Philippine locations:
  * Cities: Manila, Quezon City, Cebu, Davao, etc.
  * Regions: NCR, Luzon, Visayas, Mindanao
  * Provinces: Cavite, Laguna, Batangas, etc.
- Keep location name maximum 2 words
- If multiple locations mentioned, return the most specific one
...
Analyze: {text}"""
    ...
    def rule_based_sentiment_analysis(self, text):
        """
        Enhanced rule-based sentiment analysiswith precise bilingual keyword matching
        """
