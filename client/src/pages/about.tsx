...
export default function About() {
  return (
    ...
    >
      ...
      >
        <h2 className="text-2xl font-bold text-slate-800 mb-8">THE FOUNDERS</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <div className="aspect-square bg-slate-200 rounded-xl flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 md:w-24 h-16 md:h-24 text-slate-400">
            ...
            <p className="text-sm md:text-base text-slate-600">Core System Architecture &amp; Machine Learning</p>
          </div>
          <div className="space-y-4">
            <div className="aspect-square bg-slate-200 rounded-xl flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 md:w-24 h-16 md:h-24 text-slate-400">
            ...
            <h3 className="text-lg md:text-xl font-bold text-slate-800">Ivahnn B. Garcia</h3>
            <p className="text-sm md:text-base text-slate-600">Frontend Development &amp; User Experience</p>
          </div>
          <div className="space-y-4">
            <div className="aspect-square bg-slate-200 rounded-xl flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-16 md:w-24 h-16 md:h-24 text-slate-400">
            ...
            <h3 className="text-lg md:text-xl font-bold text-slate-800">Julia Daphne Ngan-Gatdula</h3>
            <p className="text-sm md:text-base text-slate-600">Data Resources &amp; Information Engineering</p>
          </div>
        </div>
      </motion.div>
      <motion.div 
      ...
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5 }}
      className="mt-8 bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-8 shadow-lg"
    >
