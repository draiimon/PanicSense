      ...
      >
        <div className="flex items-center justify-between h-16 px-4 border-b border-slate-700/50">
          ...
          >
            ...
            <motion.h1 
              className="text-lg font-bold bg-gradient-to-r from-blue-200 to-indigo-200 bg-clip-text text-transparent"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            {navItems.map((item, index) => (
              ...
              >
                <Link
                  href={item.href}
                  className={cn(
                    "flex items-center space-x-2 py-2 px-3 rounded-md transition-all duration-200",
                    location === item.href
