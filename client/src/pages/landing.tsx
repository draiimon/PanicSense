      ...
      >
        ...
        <div className="bg-gradient-to-br from-indigo-600 via-purple-600 to-blue-600 p-4 md:p-6 lg:p-8">          
          ...
          <div className="flex flex-col md:flex-row items-center md:items-center justify-center md:gap-8 lg:gap-12">
            {/* Tutorial Image - Column 1 - WIDER but not too tall, more centered */}
            <div 
              className="tutorial-image-container slide-up-animation video-style-effect w-full max-w-[300px] md:max-w-[450px] lg:max-w-[500px] mx-auto mt-4 md:mt-8 md:mx-0 md:aspect-video overflow-hidden"
            >
